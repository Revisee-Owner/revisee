    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-1 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display font-bold text-2xl text-ink-0">Create your account</h1>
          <p className="text-sm text-ink-3 mt-1">Start organizing your studies in minutes</p>
        </div>
        ...
        <div className="card p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-ink-1 mb-1.5">Name</label>
              <input
                type="text"
